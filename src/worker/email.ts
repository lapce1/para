...
export function receiptEmailHtml(args: {
  ...
  <h2 style="color:#FF3B30">PARA · fiskalni račun</h2>
  ...
  <p><a href="${safeUrl}"
        style="display:inline-block;background:#0A0A0A;color:#fff;padding:12px 18px;text-decoration:none;font-weight:700">

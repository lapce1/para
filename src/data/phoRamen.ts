...
export const phoRamenIntro =
  "Phở i ramen su dve najpoznatije azijske supe sa rezancima — i skoro sve " +
  "ostalo im je različito. Phở je vijetnamski: bistra goveđa ili pileća supa, " +
  "pirinčani rezanci i sveže biljke koje dodaješ sam. Ramen je japanski: gušća " +
  "pšenična supa, alkalni rezanci i dodaci složeni u kuhinji. Evo razlika, " +
  "jedna po jedna.";
...
export const phoRamenRows: PhoRamenRow[] = [
  ...
  },
  {
    ...
    ramen: "Gusta i bogata. Tonkotsu se kuva dok se ne zamuti od kolagena; ukus vodi tare (soja, miso, so) i sloj masnoće preko.",
  },
  {
    dim: "Rezanci",
    pho: "Pirinčani, ravni i svilenkasti (bánh phở). Prirodno bez glutena — upijaju supu i ostaju nežni.",
    ramen: "Pšenični, sa kansui alkalnom vodom — žuti, elastični, žvakavi. Gluten je ovde poenta.",
  },
  {
    dim: "Dodaci",
  ...
  {
    dim: "Posle jela",
    pho: "Lagano — bistra supa i pirinčani rezanci ne ostavljaju težinu. Možeš nazad na posao.",
    ramen: "Zasitno — bogata supa i masnoća drže satima. Posle ramena se ne trči.",
  },
];
...
export const phoRamenFaq: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Phở. Supa je bistra, rezanci su pirinčani (bez glutena) i nema sloja masnoće preko — zato phở možeš da jedeš i usred radnog dana.",
  },
  {
